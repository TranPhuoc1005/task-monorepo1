...
import { useUsers } from "@taskpro/shared";
import { Users, Mail, MapPin, Shield, Crown, TrendingUp } from "lucide-react";
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            {activeTab === "members" ? (
                ...
                <TeamWorkload users={users || []} tasks={tasks || []} isLoading={usersLoading || tasksLoading} />
            )}
        </div>
    );
}
